...
T11=csvread('D:\1XlinxRADAR19102016\Masters\Dr.Mabrouk\#Measurements 02-01-2018\600M 100MSPS 20M Point\180103_011317_Ch1.csv',15,3,[15 3 1000 4]); %
% T11=csvread('D:\1XlinxRADAR19102016\Masters\Dr.Mabrouk\#measurements 28-12-2017\3m1\171229_022105.csv',15,3,[15 3 49000 4]);
% T11=csvread('D:\1XlinxRADAR19102016\Masters\Dr.Mabrouk\#measurements 28-12-2017\3m2\171229_022441.csv',15,3,[15 3 24998 4]);
...
Range_Resolution=(3e8)/(2*IF_BW); %or 2*sampling_rate
...
T1=csvread('D:\1XlinxRADAR19102016\Masters\Dr.Mabrouk\#Measurements 02-01-2018\600M 100MSPS 20M Point\180103_011317_Ch1.csv',start+i,3,[start+i 3 stop+i 4]);
% T1=csvread('D:\1XlinxRADAR19102016\Masters\Dr.Mabrouk\#measurements 28-12-2017\3m1\171229_022105.csv',start+i,3,[start+i 3 stop+i 4]);
% T1=csvread('D:\1XlinxRADAR19102016\Masters\Dr.Mabrouk\#measurements 28-12-2017\3m1\171229_022105.csv',start+i,3,[start+i 3 stop+i 4]);
% 
counter= counter +1; 
if i==1
...
figure;
% 
pcolor(range,1:j,(B1).'), shading interp;title('FFT11'); 
...
fre=0:fs/n:fs-(fs/n);
figure; 
pcolor(range,1:j,transpose(DD1).'), shading interp;hold on; 
...
L=p;
y1=((T11(1:p,2))/(max(abs(T11(1:p,2)))));
figure;
plot((0:1:L-1),y1)
title('abs')
%% Generating COE file
